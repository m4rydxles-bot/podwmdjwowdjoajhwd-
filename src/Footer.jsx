        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              <img 
                src="https://customer-assets.emergentagent.com/job_hair-pro-maakaz/artifacts/o9szv2lk_image.png" 
                alt="Maakaz Hair Logo" 
                className="h-12 w-auto brightness-0 invert"
              />
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Ihr Stil. Unsere Leidenschaft. Professionelle Friseurdienstleistungen in Nürnberg.
            </p>
            {/* Social Media Links */}
            <div className="flex space-x-4">
              <a 
                href="https://www.facebook.com/p/Maakaz-100063669753776/" 
                target="_blank" 
              ...
              <a 
                href="https://www.instagram.com/friseur_maakaz/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 hover:bg-gradient-to-br hover:from-purple-600 hover:via-pink-600 hover:to-orange-500 rounded-full flex items-center justify-center transition-all duration-300 group"
              >
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-red-500">Kontakt</h3>
            <div className="space-y-3">
              <a href="tel:09116608295" className="flex items-start space-x-3 text-gray-300 hover:text-red-500 transition-colors duration-300 group">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Friseur Saloon Maakaz. Alle Rechte vorbehalten.
            </p>
